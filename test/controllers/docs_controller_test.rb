...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: { fecha: @doc.fecha, texto: @doc.texto, titulo: @doc.titulo } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: { fecha: @doc.fecha, texto: @doc.texto, titulo: @doc.titulo } }
